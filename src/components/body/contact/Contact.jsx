        ...
        <div className='Contact'>
            ...
            <div className='contactClientInfo'>
                <div className='nameEmailContainer'>
                    <input type="text"  className='inputName' onfocus="this.value=''" placeholder='Name'/>
                    <input type="email" className='inputEmail' onfocus="this.value=''" placeholder='Email'/>
                </div>
                <textarea rows="20" cols="50" className='inputMessage' onfocus="this.value=''" placeholder='Message'></textarea>
